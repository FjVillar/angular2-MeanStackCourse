...
var _View_MessagesComponent0 = (function (_super) {
    ...
    _View_MessagesComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_7 = this.renderer.createElement(this._el_5, 'app-message-input', null);
        this._appEl_7 = new import2.AppElement(7, 5, this, this._el_7);
        var compView_7 = import12.viewFactory_MessageInputComponent0(this.viewUtils, this.injector(7), this._appEl_7);
        ...
        compView_7.create(this._MessageInputComponent_7_4, [], null);
        this._text_8 = this.renderer.createText(this._el_5, '\n		', null);
        this._text_9 = this.renderer.createText(this._el_3, '\n		', null);
        this._el_10 = this.renderer.createElement(this._el_3, 'hr', null);
        this._text_11 = this.renderer.createText(this._el_3, '\n			', null);
        this._el_12 = this.renderer.createElement(this._el_3, 'app-message-list', null);
        this._appEl_12 = new import2.AppElement(12, 3, this, this._el_12);
        var compView_12 = import14.viewFactory_MessageListComponent0(this.viewUtils, this.injector(12), this._appEl_12);
        ...
        compView_12.create(this._MessageListComponent_12_4, [], null);
    ...
    _View_MessagesComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import10.MessageInputComponent) && (7 === requestNodeIndex))) {
            return this._MessageInputComponent_7_4;
        }
        if (((token === import11.MessageListComponent) && (12 === requestNodeIndex))) {
            return this._MessageListComponent_12_4;
        }
        return notFoundResult;
    };
    _View_MessagesComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._MessageInputComponent_7_4.ngOnInit();
        }
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._MessageListComponent_12_4.ngOnInit();
        }
...
export function viewFactory_MessagesComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessagesComponent === null)) {
        (renderType_MessagesComponent = viewUtils.createRenderComponentType('C:/Projects/UdemyAngularApp/assets/app/messages/messages.component.ts class MessagesComponent - inline template', 0, import8.ViewEncapsulation.None, styles_MessagesComponent, {}));
    }
